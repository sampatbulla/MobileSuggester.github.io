...
Wifi: Yes   Bluetooth: Yes   NFC: Yes   Fingerprint Scanner: No   Face Unlock: Yes -->
		...
		<div class = "main">
			...
			<label class="attribute2">Internal Memory: <br><input type="text" name="Internal Memory" placeholder="in GBs" required>  </label><br>
			<label class="attribute">Battery: <br><input type="text" name="Battery" placeholder="in mAh" required>  </label>
			<label class="attribute2">Disp Size: <br><input type="text" name="Disp Size" placeholder="in inches" required>  </label><br>
			...
			<label class="attribute2">Processor Name: <br><input type="text" name="Proc Name" placeholder="" required>  </label>
			<label class="attribute">Processor Brand: <br><input type="text" name="Proc Brand" placeholder="" required>  </label><br>
			<label class="attribute">Type of Display: <br><input type="text" name="Type of Display" placeholder="" required>  </label>
			<label class="attribute2">No of Cameras: <br><input type="text" name="No of Cameras" placeholder="" required>  </label><br>
